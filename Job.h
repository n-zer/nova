...
namespace Nova {
	...
	public:
		...
		void operator () () {
			Helpers::apply(m_callable, m_tuple);
		}
	...
	public:
		...
		void operator () () {
			...
			Helpers::apply(m_callable, params);
		}
	...
	template <typename Obj, typename ... Ts>
	SimpleJob<Helpers::MemberFunctionWrapper<Obj, Ts...>, Ts...> MakeJob(void(Obj::*func)(Ts...), Obj obj, Ts... args) {
		return SimpleJob<Helpers::MemberFunctionWrapper<Obj, Ts...>, Ts...>({ obj,func }, args...);
	}

	template <typename Obj, typename ... Ts>
	BatchJob<Helpers::MemberFunctionWrapper<Obj, Ts...>, Ts...> MakeBatchJob(void(Obj::*func)(Ts...), Obj obj, unsigned start, unsigned end, Ts... args) {
		return BatchJob<Helpers::MemberFunctionWrapper<Obj, unsigned, unsigned, Ts...>, Ts...>({ obj,func }, start, end, args...);
	}
}
